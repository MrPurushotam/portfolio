            ...
            <section id="about" className="w-full min-h-[85vh] h-fit mx-auto flex flex-col justify-center items-center p-8 dark:bg-[#10151b]">
                ...
                >
                    ...
                    <p className="text-base md:text-lg text-justify text-gray-800 dark:text-[#d2e3f8] tracking-wide leading-relaxed">
                        I thrive on building <b className="text-[#fcd34d] dark:text-[#fff4b7]">scalable</b>, high-impact solutions using <b className="text-[#fcd34d] dark:text-[#fff4b7]">React</b>, <b className="text-[#fcd34d] dark:text-[#fff4b7]">Next.js</b>, <b className="text-[#fcd34d] dark:text-[#fff4b7]">Node.js</b>, and <b className="text-[#fcd34d] dark:text-[#fff4b7]">AWS</b>. Creativity and experimentation drive my approach ΓÇö I love pushing boundaries and crafting seamless experiences that go beyond just writing code.
                    </p>
                    <p className="text-base md:text-lg text-justify text-gray-800 dark:text-[#d2e3f8] tracking-wide leading-relaxed mt-2">
                        Beyond tech, I'm deeply curious about geopolitics, enjoy reading, and love exploring new places (preferably on two wheels!). With a strategic mindset and a passion for innovation, I embrace challenges with enthusiasm and a growth-focused mindset. LetΓÇÖs build something extraordinary together.
                    </p>
                </motion.div>
                    ...
                    <div className="flex flex-col gap-2 relative pl-2 md:pl-10">
                        ...
                        <div className="relative flex items-start gap-5 group">
                            ...
                            <div className="flex flex-col pb-8">
                                ...
                                <time className="text-sm text-gray-600 dark:text-gray-500 mb-2">2022 - 2026 ΓÇó Phagwara, Punjab</time>
                            </div>
                        </div>
                        ...
                        <div className="relative flex items-start gap-5 group">
                            ...
                            <div className="flex flex-col">
                                ...
                                <time className="text-sm text-gray-600 dark:text-gray-500 mb-2">2019 - 2021 ΓÇó Rayagada, Odisha</time>
                            </div>
                        </div>
                    </div>
                </motion.div>
                ...
                <div className="w-full space-y-6">
                    <div className="relative flex flex-col justify-center items-center layout-container ">
                        ...
                        <motion.h1
                            ...
                            id="projects"
                        >
                            <span className="text-white">≡ƒÜÇ</span> Projects
                        </motion.h1>
